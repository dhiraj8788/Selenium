...
public class Test4 
{
		...
		//	driver.manage().window().maximize();
			...
			//switch focus from main to frame by passing String int frameindex as parameter of frame()
			//NOTE: if index is not there in DOM structure then we can ask to the Developer
			//call swtichTo().frame();
