...
public class test3 
{
					//To get Price of APPLE iPhone 14 Pro Max (Gold, 128 GB) in console
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//To get Price of APPLE iPhone 14 Pro Max (Gold, 128 GB)
		...
		WebElement price = driver.findElement(By.xpath("(//div[@class='_2kHMtA'])[2]//div[@class='_30jeq3 _1_WHN1']"));
		
		//To get text
		//call getText() from WebElement and returns String
		//store it into String object
		String text = price.getText();
		
		System.out.println("Price of APPLE iPhone 14 Pro Max (Gold, 128 GB)is -- "+text);
