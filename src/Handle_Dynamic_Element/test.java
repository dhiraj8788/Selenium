...
public class test 
{
						//To get Ratings of APPLE iPhone 14 Pro Max (Gold, 128 GB) in console
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//To get Ratings of APPLE iPhone 14 Pro Max (Gold, 128 GB)
		...
		//to getText
		//call getText() present in WebElement and returns String
		//store it into object have String return type
		String text = ratings.getText();
		
		System.out.println("Ratings of APPLE iPhone 14 Pro Max (Gold, 128 GB) is  --  "+text);
